// ============================================================
// Arquivo: Services/AppointmentsService.cs (VERSÃO CORRIGIDA FINAL)
// Descrição: Serviço com lógica de negócio para agendamentos
// Nota: Status é AppointmentStatus (enum), não int
// ============================================================
...
public class AppointmentsService : IAppointmentsService
{
    ...
    public async Task<AvailableSlotsDto> GetAvailableSlotsAsync(int barberId, string date, int durationMinutes)
    {
        ...
        // ✅ CORRIGIDO: Comparar Status (AppointmentStatus enum) diretamente com enum
    ...
    public async Task<Appointment> CreateAsync(CreateAppointmentDto dto)
    {
        ...
        var appointmentEnd = dto.AppointmentDateTime.AddMinutes(totalDuration);

        // ✅ CORRIGIDO: Buscar agendamentos em memória e comparar com enum
        ...
        bool hasConflict = conflictingAppointments.Any(a =>
        {
        ...
        var appointment = new Appointment
        {
            ...
            Status = AppointmentStatus.Scheduled, // ✅ CORRIGIDO: Usar enum diretamente
            Notes = dto.Notes,
    ...
    public async Task<Appointment> UpdateAsync(int id, UpdateAppointmentDto dto)
    {
        ...
        // ✅ CORRIGIDO: Comparar com enum diretamente
        if (appointment.Status != AppointmentStatus.Scheduled &&
            appointment.Status != AppointmentStatus.Confirmed)
            throw new InvalidOperationException($"Não é possível alterar um agendamento com status {appointment.Status}");
    ...
    public async Task<Appointment> UpdateStatusAsync(int id, int newStatus)
    {
        ...
        // ✅ CORRIGIDO: Atribuir enum diretamente
